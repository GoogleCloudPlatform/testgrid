...
func main() {
	...
	if err := summarizer.Update(ctx, client, metrics, opt.config, opt.concurrency, opt.tabPathPrefix, opt.summaryPathPrefix, opt.dashboards.Strings(), opt.confirm, opt.features, opt.wait, fixers...); err != nil {
