...
type ListTabSummariesRequest struct {
	...
	NumFailingTests int32 `protobuf:"varint,3,opt,name=num_failing_tests,json=numFailingTests,proto3" json:"num_failing_tests,omitempty"`
	...
	NumFlakyTests int32 `protobuf:"varint,4,opt,name=num_flaky_tests,json=numFlakyTests,proto3" json:"num_flaky_tests,omitempty"`
}
...
func (x *ListTabSummariesRequest) GetNumFailingTests() int32 {
	if x != nil {
...
func (x *ListTabSummariesRequest) GetNumFlakyTests() int32 {
	if x != nil {
...
type GetTabSummaryRequest struct {
	...
	// At most this many failing tests will be returned as part of TabSummary.
	// Will be displayed in summarized view (failing tests summary).
	NumFailingTests int32 `protobuf:"varint,4,opt,name=num_failing_tests,json=numFailingTests,proto3" json:"num_failing_tests,omitempty"`
	// Number of top flaky tests to fetch.
	// At most this many flaky tests will be returned as part of TabSummary.
	// Will be displayed in summarized view (healthiness info summary).
	NumFlakyTests int32 `protobuf:"varint,5,opt,name=num_flaky_tests,json=numFlakyTests,proto3" json:"num_flaky_tests,omitempty"`
}
...
func (x *GetTabSummaryRequest) GetNumFailingTests() int32 {
	if x != nil {
		return x.NumFailingTests
	}
	return 0
...
func (x *GetTabSummaryRequest) GetNumFlakyTests() int32 {
	if x != nil {
		return x.NumFlakyTests
	}
	return 0
...
type TabSummary struct {
	...
	// Summarized info on the tests' healthiness.
...
// Summarized representation of data from healthiness info.
...
type HealthinessSummary struct {
	...
	// Top flaky tests by current flakiness.
	// Configured via num_flaky_tests in the request.
	...
	// Aggregated healthiness stats across all tests.
...
// Subset of data from TestInfo defined in summary.proto.
type FlakyTestInfo struct {
	...
	DisplayName string `protobuf:"bytes,1,opt,name=display_name,json=displayName,proto3" json:"display_name,omitempty"`
	// Test's current flakiness, %s measured out of 100.
	...
	TrendChange summary.TestInfo_Trend `protobuf:"varint,3,opt,name=trend_change,json=trendChange,proto3,enum=testgrid.summary.TestInfo_Trend" json:"trend_change,omitempty"`
}
...
func (x *FlakyTestInfo) GetTrendChange() summary.TestInfo_Trend {
	if x != nil {
		return x.TrendChange
	}
	return summary.TestInfo_Trend(0)
}

// Aggregate healthiness stats across all tests.
type HealthinessStats struct {
	...
	// Current average flakiness across all tests.
	// Measured in % out of 100.
	...
	// Previous average flakiness across all tests.
	// Measured in % out of 100.
...
var file_data_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	0x74, 0x61, 0x74, 0x73, 0x22, 0x95, 0x01, 0x0a, 0x0d, 0x46, 0x6c, 0x61, 0x6b, 0x79, 0x54, 0x65,
	...
	0x61, 0x6b, 0x69, 0x6e, 0x65, 0x73, 0x73, 0x12, 0x43, 0x0a, 0x0c, 0x74, 0x72, 0x65, 0x6e, 0x64,
	0x5f, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x20, 0x2e,
	0x74, 0x65, 0x73, 0x74, 0x67, 0x72, 0x69, 0x64, 0x2e, 0x73, 0x75, 0x6d, 0x6d, 0x61, 0x72, 0x79,
	0x2e, 0x54, 0x65, 0x73, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x2e, 0x54, 0x72, 0x65, 0x6e, 0x64, 0x52,
	0x0b, 0x74, 0x72, 0x65, 0x6e, 0x64, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x22, 0xf6, 0x01, 0x0a,
	0x10, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x69, 0x6e, 0x65, 0x73, 0x73, 0x53, 0x74, 0x61, 0x74,
	0x73, 0x12, 0x30, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x72, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b,
	...
	,
	...
	0x44, 0x61, 0x73, 0x68, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x12, 0x2a,
	0x2e, 0x74, 0x65, 0x73, 0x74, 0x67, 0x72, 0x69, 0x64, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x31,
	...
	0x72, 0x6d, 0x2f, 0x74, 0x65, 0x73, 0x74, 0x67, 0x72, 0x69, 0x64, 0x2f, 0x70, 0x62, 0x2f, 0x61,
...
var file_data_proto_goTypes = []interface{}{
	...
	(*TabSummary)(nil),                 // 19: testgrid.api.v1.TabSummary
	(*FailuresSummary)(nil),            // 20: testgrid.api.v1.FailuresSummary
	(*FailingTestInfo)(nil),            // 21: testgrid.api.v1.FailingTestInfo
	(*FailureStats)(nil),               // 22: testgrid.api.v1.FailureStats
	(*HealthinessSummary)(nil),         // 23: testgrid.api.v1.HealthinessSummary
	(*FlakyTestInfo)(nil),              // 24: testgrid.api.v1.FlakyTestInfo
	(*HealthinessStats)(nil),           // 25: testgrid.api.v1.HealthinessStats
	(*ListHeadersResponse_Header)(nil), // 26: testgrid.api.v1.ListHeadersResponse.Header
	(*ListRowsResponse_Row)(nil),       // 27: testgrid.api.v1.ListRowsResponse.Row
	(*ListRowsResponse_Cell)(nil),      // 28: testgrid.api.v1.ListRowsResponse.Cell
	(*config.Notification)(nil),        // 29: testgrid.config.Notification
	(*timestamppb.Timestamp)(nil),      // 30: google.protobuf.Timestamp
	(summary.TestInfo_Trend)(0),        // 31: testgrid.summary.TestInfo.Trend
	(*state.AlertInfo)(nil),            // 32: testgrid.state.AlertInfo
}
var file_data_proto_depIdxs = []int32{
	...
	29, // 3: testgrid.api.v1.GetDashboardResponse.notifications:type_name -> testgrid.config.Notification
	14, // 4: testgrid.api.v1.GetDashboardGroupResponse.dashboards:type_name -> testgrid.api.v1.Resource
	26, // 5: testgrid.api.v1.ListHeadersResponse.headers:type_name -> testgrid.api.v1.ListHeadersResponse.Header
	27, // 6: testgrid.api.v1.ListRowsResponse.rows:type_name -> testgrid.api.v1.ListRowsResponse.Row
	19, // 7: testgrid.api.v1.ListTabSummariesResponse.tab_summaries:type_name -> testgrid.api.v1.TabSummary
	19, // 8: testgrid.api.v1.GetTabSummaryResponse.tab_summary:type_name -> testgrid.api.v1.TabSummary
	30, // 9: testgrid.api.v1.TabSummary.last_run_timestamp:type_name -> google.protobuf.Timestamp
	30, // 10: testgrid.api.v1.TabSummary.last_update_timestamp:type_name -> google.protobuf.Timestamp
	20, // 11: testgrid.api.v1.TabSummary.failures_summary:type_name -> testgrid.api.v1.FailuresSummary
	23, // 12: testgrid.api.v1.TabSummary.healthiness_summary:type_name -> testgrid.api.v1.HealthinessSummary
	21, // 13: testgrid.api.v1.FailuresSummary.top_failing_tests:type_name -> testgrid.api.v1.FailingTestInfo
	22, // 14: testgrid.api.v1.FailuresSummary.failure_stats:type_name -> testgrid.api.v1.FailureStats
	30, // 15: testgrid.api.v1.FailingTestInfo.pass_timestamp:type_name -> google.protobuf.Timestamp
	30, // 16: testgrid.api.v1.FailingTestInfo.fail_timestamp:type_name -> google.protobuf.Timestamp
	24, // 17: testgrid.api.v1.HealthinessSummary.top_flaky_tests:type_name -> testgrid.api.v1.FlakyTestInfo
	25, // 18: testgrid.api.v1.HealthinessSummary.healthiness_stats:type_name -> testgrid.api.v1.HealthinessStats
	31, // 19: testgrid.api.v1.FlakyTestInfo.trend_change:type_name -> testgrid.summary.TestInfo.Trend
	30, // 20: testgrid.api.v1.HealthinessStats.start:type_name -> google.protobuf.Timestamp
	30, // 21: testgrid.api.v1.HealthinessStats.end:type_name -> google.protobuf.Timestamp
	30, // 22: testgrid.api.v1.ListHeadersResponse.Header.started:type_name -> google.protobuf.Timestamp
	28, // 23: testgrid.api.v1.ListRowsResponse.Row.cells:type_name -> testgrid.api.v1.ListRowsResponse.Cell
	32, // 24: testgrid.api.v1.ListRowsResponse.Row.alert:type_name -> testgrid.state.AlertInfo
	0,  // 25: testgrid.api.v1.TestGridData.ListDashboard:input_type -> testgrid.api.v1.ListDashboardRequest
	2,  // 26: testgrid.api.v1.TestGridData.ListDashboardGroup:input_type -> testgrid.api.v1.ListDashboardGroupRequest
	4,  // 27: testgrid.api.v1.TestGridData.ListDashboardTabs:input_type -> testgrid.api.v1.ListDashboardTabsRequest
	6,  // 28: testgrid.api.v1.TestGridData.GetDashboard:input_type -> testgrid.api.v1.GetDashboardRequest
	8,  // 29: testgrid.api.v1.TestGridData.GetDashboardGroup:input_type -> testgrid.api.v1.GetDashboardGroupRequest
	10, // 30: testgrid.api.v1.TestGridData.ListHeaders:input_type -> testgrid.api.v1.ListHeadersRequest
	12, // 31: testgrid.api.v1.TestGridData.ListRows:input_type -> testgrid.api.v1.ListRowsRequest
	15, // 32: testgrid.api.v1.TestGridData.ListTabSummaries:input_type -> testgrid.api.v1.ListTabSummariesRequest
	17, // 33: testgrid.api.v1.TestGridData.GetTabSummary:input_type -> testgrid.api.v1.GetTabSummaryRequest
	1,  // 34: testgrid.api.v1.TestGridData.ListDashboard:output_type -> testgrid.api.v1.ListDashboardResponse
	3,  // 35: testgrid.api.v1.TestGridData.ListDashboardGroup:output_type -> testgrid.api.v1.ListDashboardGroupResponse
	5,  // 36: testgrid.api.v1.TestGridData.ListDashboardTabs:output_type -> testgrid.api.v1.ListDashboardTabsResponse
	7,  // 37: testgrid.api.v1.TestGridData.GetDashboard:output_type -> testgrid.api.v1.GetDashboardResponse
	9,  // 38: testgrid.api.v1.TestGridData.GetDashboardGroup:output_type -> testgrid.api.v1.GetDashboardGroupResponse
	11, // 39: testgrid.api.v1.TestGridData.ListHeaders:output_type -> testgrid.api.v1.ListHeadersResponse
	13, // 40: testgrid.api.v1.TestGridData.ListRows:output_type -> testgrid.api.v1.ListRowsResponse
	16, // 41: testgrid.api.v1.TestGridData.ListTabSummaries:output_type -> testgrid.api.v1.ListTabSummariesResponse
	18, // 42: testgrid.api.v1.TestGridData.GetTabSummary:output_type -> testgrid.api.v1.GetTabSummaryResponse
