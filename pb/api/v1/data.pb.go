...
func (m *ResultSource) GetResultSourceConfig() isResultSource_ResultSourceConfig {
	if m != nil {
...
func (x *ResultSource) GetGcsConfig() *GCSConfig {
	if x, ok := x.GetResultSourceConfig().(*ResultSource_GcsConfig); ok {
		return x.GcsConfig
	}
	return nil
}
...
func (x *ResultSource) GetResultstoreConfig() *ResultStoreConfig {
	if x, ok := x.GetResultSourceConfig().(*ResultSource_ResultstoreConfig); ok {
