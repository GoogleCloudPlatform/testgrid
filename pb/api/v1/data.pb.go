...
type LinkTemplate struct {
	...
	Options       []*LinkOptionsTemplate `protobuf:"bytes,3,rep,name=options,proto3" json:"options,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *LinkTemplate) GetText() string {
	if x != nil {
		return x.Text
	}
	return ""
...
//
// More info:
// https://github.com/GoogleCloudPlatform/testgrid/tree/main/metadata
type GCSConfig struct {
	...
	// The GCP project where GCS sends notifications for the above prefix (e.g.
	// 'my-project').
	PubsubProject string `protobuf:"bytes,2,opt,name=pubsub_project,json=pubsubProject,proto3" json:"pubsub_project,omitempty"`
	// The ID of the pubsub subscription (e.g. 'my-subscription').
...
type ResultSource struct {
	...
	//
	//	*ResultSource_GcsConfig
	//	*ResultSource_ResultstoreConfig
	ResultSourceConfig isResultSource_ResultSourceConfig `protobuf_oneof:"result_source_config"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}

func (x *ResultSource) Reset() {
	*x = ResultSource{}
...
func (x *ResultSource) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ResultSource) ProtoMessage() {}

func (x *ResultSource) ProtoReflect() protoreflect.Message {
	mi := &file_data_proto_msgTypes[11]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ResultSource.ProtoReflect.Descriptor instead.
func (*ResultSource) Descriptor() ([]byte, []int) {
	return file_data_proto_rawDescGZIP(), []int{11}
}

func (x *ResultSource) GetResultSourceConfig() isResultSource_ResultSourceConfig {
	if x != nil {
		return x.ResultSourceConfig
	}
	return nil
}

func (x *ResultSource) GetGcsConfig() *GCSConfig {
	if x != nil {
		if x, ok := x.ResultSourceConfig.(*ResultSource_GcsConfig); ok {
			return x.GcsConfig
		}
	}
	return nil
...
func (x *ResultSource) GetResultstoreConfig() *ResultStoreConfig {
	if x != nil {
		if x, ok := x.ResultSourceConfig.(*ResultSource_ResultstoreConfig); ok {
...
type isResultSource_ResultSourceConfig interface {
	isResultSource_ResultSourceConfig()
}

type ResultSource_GcsConfig struct {
...
type ResultSource_ResultstoreConfig struct {
...
func (*ResultSource_GcsConfig) isResultSource_ResultSourceConfig() {}

func (*ResultSource_ResultstoreConfig) isResultSource_ResultSourceConfig() {}

type AlertOptions struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Consider a row stale if it has no results for many columns.
	NumColumnsRecent int32 `protobuf:"varint,1,opt,name=num_columns_recent,json=numColumnsRecent,proto3" json:"num_columns_recent,omitempty"`
	// If not zero, consider a tab stale and raise an alert for the tab if there
	// are no results within this many hours.
	AlertStaleResultsHours int32 `protobuf:"varint,2,opt,name=alert_stale_results_hours,json=alertStaleResultsHours,proto3" json:"alert_stale_results_hours,omitempty"`
	// If not zero, open an alert when this many failures have occurred for a row.
	NumFailuresToAlert int32 `protobuf:"varint,3,opt,name=num_failures_to_alert,json=numFailuresToAlert,proto3" json:"num_failures_to_alert,omitempty"`
	// Close an alert if this many passes have occurred for a row.
...
func (x *AlertOptions) GetNumColumnsRecent() int32 {
	if x != nil {
...
func (x *AlertOptions) GetAlertStaleResultsHours() int32 {
	if x != nil {
...
func (x *AlertOptions) GetNumFailuresToAlert() int32 {
	if x != nil {
...
func (x *AlertOptions) GetNumPassesToDisableAlert() int32 {
	if x != nil {
...
type GetDashboardTabResponse struct {
	...
	// Name of the test group backing this tab.
	...
	// Where/how to pull test results.
	ResultSource *ResultSource `protobuf:"bytes,4,opt,name=result_source,json=resultSource,proto3" json:"result_source,omitempty"`
	// (includes about_dashboard_url link, results link (results_text and
	// results_url_template), )
	// Links for the 'Overall' menu.
	TabMenuTemplates []*LinkTemplate `protobuf:"bytes,5,rep,name=tab_menu_templates,json=tabMenuTemplates,proto3" json:"tab_menu_templates,omitempty"`
	// (includes column_diff_link_templates; listed in the context menu in order)
	// (also open_test_template, open_bug_template, file_bug_template,
	// attach_bug_template)
	// Links for the context menu on an individual cell.
	CellMenuTemplates []*LinkTemplate `protobuf:"bytes,6,rep,name=cell_menu_templates,json=cellMenuTemplates,proto3" json:"cell_menu_templates,omitempty"`
	// (build from code_search_path and code_search_url_template)
	// Links for the context menu shown when comparing two columns.
	ColumnDiffTemplates []*LinkTemplate `protobuf:"bytes,7,rep,name=column_diff_templates,json=columnDiffTemplates,proto3" json:"column_diff_templates,omitempty"`
	// Options that affect what counts as an alert (continuous failure).
	// (build from num_columns_recent, alert_options,
	// status_customization_options, broken_column_threshold)
	AlertOptions *AlertOptions `protobuf:"bytes,8,opt,name=alert_options,json=alertOptions,proto3" json:"alert_options,omitempty"`
	// Default display options.
	BaseOptions string `protobuf:"bytes,9,opt,name=base_options,json=baseOptions,proto3" json:"base_options,omitempty"`
	// If true, display the local time by default (as opposed to Pacific Time).
	DisplayLocalTime bool `protobuf:"varint,10,opt,name=display_local_time,json=displayLocalTime,proto3" json:"display_local_time,omitempty"`
	// If set, display the row name as a table of info.
	TabularNamesRegex string `protobuf:"bytes,11,opt,name=tabular_names_regex,json=tabularNamesRegex,proto3" json:"tabular_names_regex,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *GetDashboardTabResponse) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *GetDashboardTabResponse) GetTestGroupName() string {
	if x != nil {
...
func (x *GetDashboardTabResponse) GetDescription() string {
	if x != nil {
...
func (x *GetDashboardTabResponse) GetResultSource() *ResultSource {
	if x != nil {
...
func (x *GetDashboardTabResponse) GetTabMenuTemplates() []*LinkTemplate {
	if x != nil {
		return x.TabMenuTemplates
	}
	return nil
}

func (x *GetDashboardTabResponse) GetCellMenuTemplates() []*LinkTemplate {
	if x != nil {
		return x.CellMenuTemplates
	}
	return nil
}

func (x *GetDashboardTabResponse) GetColumnDiffTemplates() []*LinkTemplate {
	if x != nil {
		return x.ColumnDiffTemplates
	}
	return nil
}

func (x *GetDashboardTabResponse) GetAlertOptions() *AlertOptions {
	if x != nil {
...
func (x *GetDashboardTabResponse) GetBaseOptions() string {
	if x != nil {
...
func (x *GetDashboardTabResponse) GetDisplayLocalTime() bool {
	if x != nil {
...
func (x *GetDashboardTabResponse) GetTabularNamesRegex() string {
	if x != nil {
...
// It includes the name of the resource, a link, and a dashboard group to which
// it belongs
...
type TabSummary struct {
	...
	// In this case, any test which raised an alert and did not suppress it is
	// considered failing.
...
// Contains the info required to render dashboard summary in UI (done in the
...
type DashboardSummary struct {
	...
	TabStatusCount map[string]int32 `protobuf:"bytes,3,rep,name=tab_status_count,json=tabStatusCount,proto3" json:"tab_status_count,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (*ListHeadersResponse_Header) Descriptor() ([]byte, []int) {
	return file_data_proto_rawDescGZIP(), []int{19, 0}
}
...
func (*ListRowsResponse_Cell) Descriptor() ([]byte, []int) {
	return file_data_proto_rawDescGZIP(), []int{21, 1}
}
...
var file_data_proto_rawDesc = []byte{
	...
	0x73, 0x68, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x54, 0x61, 0x62, 0x73, 0x22, 0x5e, 0x0a, 0x16, 0x47,
	...
	,
	...
	,
	...
	0x1c, 0x0a, 0x09, 0x64, 0x61, 0x73, 0x68, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x09, 0x64, 0x61, 0x73, 0x68, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x22, 0xd9, 0x01,
	0x0a, 0x14, 0x47, 0x65, 0x74, 0x44, 0x61, 0x73, 0x68, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x43, 0x0a, 0x0d, 0x6e, 0x6f, 0x74, 0x69, 0x66, 0x69,
	...
	,
	...
	,
	...
	0x6f, 0x74, 0x6c, 0x69, 0x73, 0x74, 0x49, 0x64, 0x73, 0x22, 0x57, 0x0a, 0x0f, 0x4c, 0x69, 0x73,
	...
	,
	...
	,
	...
	0x22, 0x6d, 0x0a, 0x11, 0x44, 0x61, 0x73, 0x68, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x52, 0x65, 0x73,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x73, 0x74, 0x1a, 0x28, 0x2e, 0x74, 0x65, 0x73, 0x74, 0x67, 0x72, 0x69, 0x64, 0x2e, 0x61, 0x70,
	0x69, 0x2e, 0x76, 0x31, 0x2e, 0x47, 0x65, 0x74, 0x44, 0x61, 0x73, 0x68, 0x62, 0x6f, 0x61, 0x72,
	0x64, 0x54, 0x61, 0x62, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x5d,
	0x0a, 0x0c, 0x47, 0x65, 0x74, 0x44, 0x61, 0x73, 0x68, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x12, 0x24,
	0x2e, 0x74, 0x65, 0x73, 0x74, 0x67, 0x72, 0x69, 0x64, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x31,
	0x2e, 0x47, 0x65, 0x74, 0x44, 0x61, 0x73, 0x68, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x25, 0x2e, 0x74, 0x65, 0x73, 0x74, 0x67, 0x72, 0x69, 0x64, 0x2e,
	...
	,
	...
	,
	...
	0x79, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x2c, 0x2e, 0x74, 0x65, 0x73, 0x74, 0x67,
	...
	0x75, 0x64, 0x50, 0x6c, 0x61, 0x74, 0x66, 0x6f, 0x72, 0x6d, 0x2f, 0x74, 0x65, 0x73, 0x74, 0x67,
	0x72, 0x69, 0x64, 0x2f, 0x70, 0x62, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x76, 0x31, 0x62, 0x06, 0x70,
...
var file_data_proto_goTypes = []any{
	...
	(*GetDashboardTabRequest)(nil),         // 6: testgrid.api.v1.GetDashboardTabRequest
	(*LinkOptionsTemplate)(nil),            // 7: testgrid.api.v1.LinkOptionsTemplate
	(*LinkTemplate)(nil),                   // 8: testgrid.api.v1.LinkTemplate
	(*GCSConfig)(nil),                      // 9: testgrid.api.v1.GCSConfig
	(*ResultStoreConfig)(nil),              // 10: testgrid.api.v1.ResultStoreConfig
	(*ResultSource)(nil),                   // 11: testgrid.api.v1.ResultSource
	(*AlertOptions)(nil),                   // 12: testgrid.api.v1.AlertOptions
	(*GetDashboardTabResponse)(nil),        // 13: testgrid.api.v1.GetDashboardTabResponse
	(*GetDashboardRequest)(nil),            // 14: testgrid.api.v1.GetDashboardRequest
	(*GetDashboardResponse)(nil),           // 15: testgrid.api.v1.GetDashboardResponse
	(*GetDashboardGroupRequest)(nil),       // 16: testgrid.api.v1.GetDashboardGroupRequest
	(*GetDashboardGroupResponse)(nil),      // 17: testgrid.api.v1.GetDashboardGroupResponse
	(*ListHeadersRequest)(nil),             // 18: testgrid.api.v1.ListHeadersRequest
	(*ListHeadersResponse)(nil),            // 19: testgrid.api.v1.ListHeadersResponse
	(*ListRowsRequest)(nil),                // 20: testgrid.api.v1.ListRowsRequest
	(*ListRowsResponse)(nil),               // 21: testgrid.api.v1.ListRowsResponse
	(*Resource)(nil),                       // 22: testgrid.api.v1.Resource
	(*DashboardResource)(nil),              // 23: testgrid.api.v1.DashboardResource
	(*ListTabSummariesRequest)(nil),        // 24: testgrid.api.v1.ListTabSummariesRequest
	(*ListTabSummariesResponse)(nil),       // 25: testgrid.api.v1.ListTabSummariesResponse
	(*GetTabSummaryRequest)(nil),           // 26: testgrid.api.v1.GetTabSummaryRequest
	(*GetTabSummaryResponse)(nil),          // 27: testgrid.api.v1.GetTabSummaryResponse
	(*ListDashboardSummariesRequest)(nil),  // 28: testgrid.api.v1.ListDashboardSummariesRequest
	(*ListDashboardSummariesResponse)(nil), // 29: testgrid.api.v1.ListDashboardSummariesResponse
	(*GetDashboardSummaryRequest)(nil),     // 30: testgrid.api.v1.GetDashboardSummaryRequest
	(*GetDashboardSummaryResponse)(nil),    // 31: testgrid.api.v1.GetDashboardSummaryResponse
	(*TabSummary)(nil),                     // 32: testgrid.api.v1.TabSummary
	(*FailuresSummary)(nil),                // 33: testgrid.api.v1.FailuresSummary
	(*FailingTestInfo)(nil),                // 34: testgrid.api.v1.FailingTestInfo
	(*FailureStats)(nil),                   // 35: testgrid.api.v1.FailureStats
	(*HealthinessSummary)(nil),             // 36: testgrid.api.v1.HealthinessSummary
	(*FlakyTestInfo)(nil),                  // 37: testgrid.api.v1.FlakyTestInfo
	(*HealthinessStats)(nil),               // 38: testgrid.api.v1.HealthinessStats
	(*DashboardSummary)(nil),               // 39: testgrid.api.v1.DashboardSummary
	(*ListHeadersResponse_Header)(nil),     // 40: testgrid.api.v1.ListHeadersResponse.Header
	(*ListRowsResponse_Row)(nil),           // 41: testgrid.api.v1.ListRowsResponse.Row
	(*ListRowsResponse_Cell)(nil),          // 42: testgrid.api.v1.ListRowsResponse.Cell
	nil,                                    // 43: testgrid.api.v1.DashboardSummary.TabStatusCountEntry
	(*config.Notification)(nil),            // 44: testgrid.config.Notification
	(*timestamppb.Timestamp)(nil),          // 45: google.protobuf.Timestamp
	(summary.TestInfo_Trend)(0),            // 46: testgrid.summary.TestInfo.Trend
	(*state.AlertInfo)(nil),                // 47: testgrid.state.AlertInfo
}
var file_data_proto_depIdxs = []int32{
	23, // 0: testgrid.api.v1.ListDashboardsResponse.dashboards:type_name -> testgrid.api.v1.DashboardResource
	22, // 1: testgrid.api.v1.ListDashboardGroupsResponse.dashboard_groups:type_name -> testgrid.api.v1.Resource
	22, // 2: testgrid.api.v1.ListDashboardTabsResponse.dashboard_tabs:type_name -> testgrid.api.v1.Resource
	7,  // 3: testgrid.api.v1.LinkTemplate.options:type_name -> testgrid.api.v1.LinkOptionsTemplate
	9,  // 4: testgrid.api.v1.ResultSource.gcs_config:type_name -> testgrid.api.v1.GCSConfig
	10, // 5: testgrid.api.v1.ResultSource.resultstore_config:type_name -> testgrid.api.v1.ResultStoreConfig
	11, // 6: testgrid.api.v1.GetDashboardTabResponse.result_source:type_name -> testgrid.api.v1.ResultSource
	8,  // 7: testgrid.api.v1.GetDashboardTabResponse.tab_menu_templates:type_name -> testgrid.api.v1.LinkTemplate
	8,  // 8: testgrid.api.v1.GetDashboardTabResponse.cell_menu_templates:type_name -> testgrid.api.v1.LinkTemplate
	8,  // 9: testgrid.api.v1.GetDashboardTabResponse.column_diff_templates:type_name -> testgrid.api.v1.LinkTemplate
	12, // 10: testgrid.api.v1.GetDashboardTabResponse.alert_options:type_name -> testgrid.api.v1.AlertOptions
	44, // 11: testgrid.api.v1.GetDashboardResponse.notifications:type_name -> testgrid.config.Notification
	22, // 12: testgrid.api.v1.GetDashboardGroupResponse.dashboards:type_name -> testgrid.api.v1.Resource
	40, // 13: testgrid.api.v1.ListHeadersResponse.headers:type_name -> testgrid.api.v1.ListHeadersResponse.Header
	41, // 14: testgrid.api.v1.ListRowsResponse.rows:type_name -> testgrid.api.v1.ListRowsResponse.Row
	32, // 15: testgrid.api.v1.ListTabSummariesResponse.tab_summaries:type_name -> testgrid.api.v1.TabSummary
	32, // 16: testgrid.api.v1.GetTabSummaryResponse.tab_summary:type_name -> testgrid.api.v1.TabSummary
	39, // 17: testgrid.api.v1.ListDashboardSummariesResponse.dashboard_summaries:type_name -> testgrid.api.v1.DashboardSummary
	39, // 18: testgrid.api.v1.GetDashboardSummaryResponse.dashboard_summary:type_name -> testgrid.api.v1.DashboardSummary
	45, // 19: testgrid.api.v1.TabSummary.last_run_timestamp:type_name -> google.protobuf.Timestamp
	45, // 20: testgrid.api.v1.TabSummary.last_update_timestamp:type_name -> google.protobuf.Timestamp
	33, // 21: testgrid.api.v1.TabSummary.failures_summary:type_name -> testgrid.api.v1.FailuresSummary
	36, // 22: testgrid.api.v1.TabSummary.healthiness_summary:type_name -> testgrid.api.v1.HealthinessSummary
	34, // 23: testgrid.api.v1.FailuresSummary.top_failing_tests:type_name -> testgrid.api.v1.FailingTestInfo
	35, // 24: testgrid.api.v1.FailuresSummary.failure_stats:type_name -> testgrid.api.v1.FailureStats
	45, // 25: testgrid.api.v1.FailingTestInfo.pass_timestamp:type_name -> google.protobuf.Timestamp
	45, // 26: testgrid.api.v1.FailingTestInfo.fail_timestamp:type_name -> google.protobuf.Timestamp
	37, // 27: testgrid.api.v1.HealthinessSummary.top_flaky_tests:type_name -> testgrid.api.v1.FlakyTestInfo
	38, // 28: testgrid.api.v1.HealthinessSummary.healthiness_stats:type_name -> testgrid.api.v1.HealthinessStats
	46, // 29: testgrid.api.v1.FlakyTestInfo.change:type_name -> testgrid.summary.TestInfo.Trend
	45, // 30: testgrid.api.v1.HealthinessStats.start:type_name -> google.protobuf.Timestamp
	45, // 31: testgrid.api.v1.HealthinessStats.end:type_name -> google.protobuf.Timestamp
	43, // 32: testgrid.api.v1.DashboardSummary.tab_status_count:type_name -> testgrid.api.v1.DashboardSummary.TabStatusCountEntry
	45, // 33: testgrid.api.v1.ListHeadersResponse.Header.started:type_name -> google.protobuf.Timestamp
	42, // 34: testgrid.api.v1.ListRowsResponse.Row.cells:type_name -> testgrid.api.v1.ListRowsResponse.Cell
	47, // 35: testgrid.api.v1.ListRowsResponse.Row.alert:type_name -> testgrid.state.AlertInfo
	0,  // 36: testgrid.api.v1.TestGridData.ListDashboards:input_type -> testgrid.api.v1.ListDashboardsRequest
	2,  // 37: testgrid.api.v1.TestGridData.ListDashboardGroups:input_type -> testgrid.api.v1.ListDashboardGroupsRequest
	4,  // 38: testgrid.api.v1.TestGridData.ListDashboardTabs:input_type -> testgrid.api.v1.ListDashboardTabsRequest
	6,  // 39: testgrid.api.v1.TestGridData.GetDashboardTab:input_type -> testgrid.api.v1.GetDashboardTabRequest
	14, // 40: testgrid.api.v1.TestGridData.GetDashboard:input_type -> testgrid.api.v1.GetDashboardRequest
	16, // 41: testgrid.api.v1.TestGridData.GetDashboardGroup:input_type -> testgrid.api.v1.GetDashboardGroupRequest
	18, // 42: testgrid.api.v1.TestGridData.ListHeaders:input_type -> testgrid.api.v1.ListHeadersRequest
	20, // 43: testgrid.api.v1.TestGridData.ListRows:input_type -> testgrid.api.v1.ListRowsRequest
	24, // 44: testgrid.api.v1.TestGridData.ListTabSummaries:input_type -> testgrid.api.v1.ListTabSummariesRequest
	26, // 45: testgrid.api.v1.TestGridData.GetTabSummary:input_type -> testgrid.api.v1.GetTabSummaryRequest
	28, // 46: testgrid.api.v1.TestGridData.ListDashboardSummaries:input_type -> testgrid.api.v1.ListDashboardSummariesRequest
	30, // 47: testgrid.api.v1.TestGridData.GetDashboardSummary:input_type -> testgrid.api.v1.GetDashboardSummaryRequest
	1,  // 48: testgrid.api.v1.TestGridData.ListDashboards:output_type -> testgrid.api.v1.ListDashboardsResponse
	3,  // 49: testgrid.api.v1.TestGridData.ListDashboardGroups:output_type -> testgrid.api.v1.ListDashboardGroupsResponse
	5,  // 50: testgrid.api.v1.TestGridData.ListDashboardTabs:output_type -> testgrid.api.v1.ListDashboardTabsResponse
	13, // 51: testgrid.api.v1.TestGridData.GetDashboardTab:output_type -> testgrid.api.v1.GetDashboardTabResponse
	15, // 52: testgrid.api.v1.TestGridData.GetDashboard:output_type -> testgrid.api.v1.GetDashboardResponse
	17, // 53: testgrid.api.v1.TestGridData.GetDashboardGroup:output_type -> testgrid.api.v1.GetDashboardGroupResponse
	19, // 54: testgrid.api.v1.TestGridData.ListHeaders:output_type -> testgrid.api.v1.ListHeadersResponse
	21, // 55: testgrid.api.v1.TestGridData.ListRows:output_type -> testgrid.api.v1.ListRowsResponse
	25, // 56: testgrid.api.v1.TestGridData.ListTabSummaries:output_type -> testgrid.api.v1.ListTabSummariesResponse
	27, // 57: testgrid.api.v1.TestGridData.GetTabSummary:output_type -> testgrid.api.v1.GetTabSummaryResponse
	29, // 58: testgrid.api.v1.TestGridData.ListDashboardSummaries:output_type -> testgrid.api.v1.ListDashboardSummariesResponse
	31, // 59: testgrid.api.v1.TestGridData.GetDashboardSummary:output_type -> testgrid.api.v1.GetDashboardSummaryResponse
...
func file_data_proto_init() {
	...
	file_data_proto_msgTypes[11].OneofWrappers = []any{
		(*ResultSource_GcsConfig)(nil),
		(*ResultSource_ResultstoreConfig)(nil),
	}
	type x struct{}
...
type TestGridDataClient interface {
	...
	// Returns a Dashboard Tab config's metadata (including all relevant
	// configuration from either the Dashboard Tab or its backing Test Group).
