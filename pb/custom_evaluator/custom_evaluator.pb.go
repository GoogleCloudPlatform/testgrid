...
func (x *TestResultComparison) GetTestResultInfo() isTestResultComparison_TestResultInfo {
	if x != nil {
		return x.TestResultInfo
	}
	return nil
}
...
func (x *TestResultComparison) GetPropertyKey() string {
	if x != nil {
		if x, ok := x.TestResultInfo.(*TestResultComparison_PropertyKey); ok {
...
func (x *TestResultComparison) GetTestResultField() string {
	if x != nil {
		if x, ok := x.TestResultInfo.(*TestResultComparison_TestResultField); ok {
...
func (x *TestResultComparison) GetTestResultErrorField() string {
	if x != nil {
		if x, ok := x.TestResultInfo.(*TestResultComparison_TestResultErrorField); ok {
...
func (x *TestResultComparison) GetTargetStatus() bool {
	if x != nil {
		if x, ok := x.TestResultInfo.(*TestResultComparison_TargetStatus); ok {
...
func (x *Comparison) GetComparisonValue() isComparison_ComparisonValue {
	if x != nil {
...
func (x *Comparison) GetStringValue() string {
	if x != nil {
		if x, ok := x.ComparisonValue.(*Comparison_StringValue); ok {
...
func (x *Comparison) GetNumericalValue() float64 {
	if x != nil {
		if x, ok := x.ComparisonValue.(*Comparison_NumericalValue); ok {
...
func (x *Comparison) GetTargetStatusValue() test_status.TestStatus {
	if x != nil {
		if x, ok := x.ComparisonValue.(*Comparison_TargetStatusValue); ok {
...
var file_custom_evaluator_proto_goTypes = []any{
...
func file_custom_evaluator_proto_init() {
	...
	file_custom_evaluator_proto_msgTypes[2].OneofWrappers = []any{
	...
	file_custom_evaluator_proto_msgTypes[3].OneofWrappers = []any{
