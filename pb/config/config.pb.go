...
//
// Invocations are stored in a Google Cloud Platform project, and searched with a query.
type ResultStoreConfig struct {
	...
	// ResultStore search query, as used by `SearchInvocationsRequest.query`.
	Query string `protobuf:"bytes,2,opt,name=query,proto3" json:"query,omitempty"`
	// Like `query`, but simpler syntax. Note:
	// - no `before:`, `after:`, or `status:` tokens
	// - AND/OR combinations must be unambiguous
	// Useful tokens:
	// - `label:<label>`
	// - `user:<user>`
	// - `<configuration_value_key>:<configuration_value_value>` (case_sensitive)
	// - `[target|exact_target]:<exact target name>`
	// - AND/OR/NOT (case-sensitive)
	SimpleQuery string `protobuf:"bytes,3,opt,name=simple_query,json=simpleQuery,proto3" json:"simple_query,omitempty"`
}
...
func (x *ResultStoreConfig) GetSimpleQuery() string {
	if x != nil {
...
type TestGroup_ResultSource_ResultStoreConfig struct {
	ResultStoreConfig *ResultStoreConfig `protobuf:"bytes,6,opt,name=result_store_config,json=resultStoreConfig,proto3,oneof"`
}
...
var file_config_proto_rawDesc = []byte{
	...
	0x65, 0x78, 0x74, 0x4c, 0x69, 0x6e, 0x6b, 0x22, 0x9a, 0x20, 0x0a, 0x09, 0x54, 0x65, 0x73, 0x74,
	...
	0x1a, 0xd1, 0x01, 0x0a, 0x0c, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x53, 0x6f, 0x75, 0x72, 0x63,
	...
	,
	...
	,
...
var file_config_proto_depIdxs = []int32{
	...
	9,  // 40: testgrid.config.TestGroup.ResultSource.result_store_config:type_name -> testgrid.config.ResultStoreConfig
