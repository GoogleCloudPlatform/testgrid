...
func (x *HotlistIdFromSource) GetHotlistIdSource() isHotlistIdFromSource_HotlistIdSource {
	if x != nil {
		return x.HotlistIdSource
	}
	return nil
}
...
func (x *HotlistIdFromSource) GetValue() int64 {
	if x != nil {
		if x, ok := x.HotlistIdSource.(*HotlistIdFromSource_Value); ok {
			return x.Value
		}
	}
	return 0
...
func (x *HotlistIdFromSource) GetLabel() string {
	if x != nil {
		if x, ok := x.HotlistIdSource.(*HotlistIdFromSource_Label); ok {
			return x.Label
		}
	}
	return ""
...
func (x *TestGroup_TestAnnotation) GetShortTextMessageSource() isTestGroup_TestAnnotation_ShortTextMessageSource {
	if x != nil {
		return x.ShortTextMessageSource
	}
	return nil
}
...
func (x *TestGroup_TestAnnotation) GetPropertyName() string {
	if x != nil {
		if x, ok := x.ShortTextMessageSource.(*TestGroup_TestAnnotation_PropertyName); ok {
...
func (x *TestGroup_ResultSource) GetResultSourceConfig() isTestGroup_ResultSource_ResultSourceConfig {
	if x != nil {
...
func (x *TestGroup_ResultSource) GetGcsConfig() *GCSConfig {
	if x != nil {
		if x, ok := x.ResultSourceConfig.(*TestGroup_ResultSource_GcsConfig); ok {
			return x.GcsConfig
		}
	}
	return nil
...
func (x *TestGroup_ResultSource) GetResultstoreConfig() *ResultStoreConfig {
	if x != nil {
		if x, ok := x.ResultSourceConfig.(*TestGroup_ResultSource_ResultstoreConfig); ok {
