...
func (x *HealthinessInfo) GetStart() *timestamp.Timestamp {
	if x != nil {
		return x.Start
	}
	return nil
...
func (x *HealthinessInfo) GetEnd() *timestamp.Timestamp {
	if x != nil {
		return x.End
	}
	return nil
...
func (x *AlertingData) GetLastEmailTime() *timestamp.Timestamp {
	if x != nil {
...
var file_summary_proto_rawDesc = []byte{
	...
	0x6d, 0x61, 0x72, 0x69, 0x65, 0x73, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
