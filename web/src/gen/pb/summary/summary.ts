  ...
  private binaryReadMap15(
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        default:
          throw new globalThis.Error(
            'unknown map entry field for field testgrid.summary.FailingTestSummary.properties'
          );
      }
    }
    map[key ?? ''] = val ?? '';
  ...
  private binaryReadMap11(
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        default:
          throw new globalThis.Error(
            'unknown map entry field for field testgrid.summary.TestInfo.infra_failures'
          );
      }
    }
    map[key ?? ''] = val ?? 0;
  ...
  constructor() {
    super('testgrid.summary.DashboardTabSummary', [
      ...
      { no: 6, name: 'status', kind: 'scalar', T: 9 /*ScalarType.STRING*/ },
      {
        ...
        kind: 'enum',
        T: () => [
          'testgrid.summary.DashboardTabSummary.TabStatus',
