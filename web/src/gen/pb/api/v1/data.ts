...
class ListDashboardsResponse$Type extends MessageType<ListDashboardsResponse> {
    constructor() {
        super("testgrid.api.v1.ListDashboardsResponse", [
            { no: 1, name: "dashboards", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => DashboardResource }
        ]);
    }
...
class ListDashboardGroupsResponse$Type extends MessageType<ListDashboardGroupsResponse> {
    constructor() {
        super("testgrid.api.v1.ListDashboardGroupsResponse", [
            { no: 1, name: "dashboard_groups", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => Resource }
        ]);
    }
...
class ListDashboardTabsResponse$Type extends MessageType<ListDashboardTabsResponse> {
    constructor() {
        super("testgrid.api.v1.ListDashboardTabsResponse", [
            { no: 1, name: "dashboard_tabs", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => Resource }
        ]);
    }
...
class GetDashboardResponse$Type extends MessageType<GetDashboardResponse> {
    ...
    create(value?: PartialMessage<GetDashboardResponse>): GetDashboardResponse {
        const message = { notifications: [], defaultTab: "", suppressFailingTabs: false, highlightToday: false };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class GetDashboardGroupResponse$Type extends MessageType<GetDashboardGroupResponse> {
    constructor() {
        super("testgrid.api.v1.GetDashboardGroupResponse", [
            { no: 1, name: "dashboards", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => Resource }
        ]);
    }
...
class ListHeadersResponse$Type extends MessageType<ListHeadersResponse> {
    constructor() {
        super("testgrid.api.v1.ListHeadersResponse", [
            { no: 1, name: "headers", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => ListHeadersResponse_Header }
        ]);
    }
...
class ListRowsResponse$Type extends MessageType<ListRowsResponse> {
    constructor() {
        super("testgrid.api.v1.ListRowsResponse", [
            { no: 1, name: "rows", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => ListRowsResponse_Row }
        ]);
    }
...
class ListRowsResponse_Row$Type extends MessageType<ListRowsResponse_Row> {
    constructor() {
        super("testgrid.api.v1.ListRowsResponse.Row", [
            ...
            { no: 2, name: "cells", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => ListRowsResponse_Cell },
...
class ListTabSummariesResponse$Type extends MessageType<ListTabSummariesResponse> {
    constructor() {
        super("testgrid.api.v1.ListTabSummariesResponse", [
            { no: 1, name: "tab_summaries", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => TabSummary }
        ]);
    }
...
class ListDashboardSummariesResponse$Type extends MessageType<ListDashboardSummariesResponse> {
    constructor() {
        super("testgrid.api.v1.ListDashboardSummariesResponse", [
            { no: 1, name: "dashboard_summaries", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => DashboardSummary }
        ]);
    }
...
class TabSummary$Type extends MessageType<TabSummary> {
    ...
    create(value?: PartialMessage<TabSummary>): TabSummary {
        const message = { dashboardName: "", tabName: "", overallStatus: "", detailedStatusMessage: "", latestPassingBuild: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class FailuresSummary$Type extends MessageType<FailuresSummary> {
    constructor() {
        super("testgrid.api.v1.FailuresSummary", [
            { no: 1, name: "top_failing_tests", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => FailingTestInfo },
...
class HealthinessSummary$Type extends MessageType<HealthinessSummary> {
    constructor() {
        super("testgrid.api.v1.HealthinessSummary", [
            { no: 1, name: "top_flaky_tests", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => FlakyTestInfo },
...
class HealthinessStats$Type extends MessageType<HealthinessStats> {
    ...
    create(value?: PartialMessage<HealthinessStats>): HealthinessStats {
        const message = { numFlakyTests: 0, averageFlakiness: 0, previousFlakiness: 0 };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.int32();
                    break;
                default: throw new globalThis.Error("unknown map entry field for field testgrid.api.v1.DashboardSummary.tab_status_count");
            }
        }
        map[key ?? ""] = val ?? 0;
    }
