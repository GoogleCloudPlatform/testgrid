...
class TestGroup$Type extends MessageType<TestGroup> {
  constructor() {
    super('testgrid.config.TestGroup', [
      ...
      { no: 5, name: 'ignore_built', kind: 'scalar', T: 8 /*ScalarType.BOOL*/ },
      {
        ...
        kind: 'enum',
        T: () => [
          'testgrid.config.TestGroup.TestsName',
          TestGroup_TestsName,
          'TESTS_NAME_',
        ],
      },
      ...
      },
      {
        ...
        kind: 'enum',
        T: () => [
          'testgrid.config.TestGroup.FallbackGrouping',
      ...
      },
      {
        ...
        kind: 'enum',
        T: () => [
          'testgrid.config.TestGroup.PrimaryGrouping',
      ...
      {
        no: 63,
        name: 'issue_gather_options',
        kind: 'message',
        T: () => IssueGatherOptions,
      },
    ]);
  }
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* testgrid.config.IssueGatherOptions issue_gather_options */ 63:
          message.issueGatherOptions = IssueGatherOptions.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
  ...
  internalBinaryWrite(
    ...
    if (message.issueGatherOptions)
      IssueGatherOptions.internalBinaryWrite(
        message.issueGatherOptions,
        writer.tag(63, WireType.LengthDelimited).fork(),
        options
      ).join();
    let u = options.writeUnknownFields;
    if (u !== false)
  ...
  constructor() {
    super('testgrid.config.AutoBugOptions', [
      ...
      },
      {
        ...
        kind: 'enum',
        T: () => [
          'testgrid.config.AutoBugOptions.Priority',
          AutoBugOptions_Priority,
        ],
      },
      {
        no: 4,
  ...
  constructor() {
    super('testgrid.config.DashboardTabStatusCustomizationOptions', [
      ...
      },
      {
        ...
        repeat: 1 /*RepeatType.PACKED*/,
        T: () => [
          'testgrid.config.DashboardTabStatusCustomizationOptions.IgnoredTestStatus',
