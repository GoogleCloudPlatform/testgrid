...
// @generated from protobuf file "pb/summary/summary.proto" (syntax proto3)
// tslint:disable
//
 ...
 *
 * @generated from protobuf message FailingTestSummary
 */
 ...
 * Next ID: 12
 *
 * @generated from protobuf message TestInfo
 */
export interface TestInfo {
   ...
   * a default of 7 days.
   *
   * @generated from protobuf field: TestInfo.Trend change_from_last_interval = 9;
   */
...
/**
 * @generated from protobuf enum TestInfo.Trend
 */
 ...
 *
 * @generated from protobuf message HealthinessInfo
 */
export interface HealthinessInfo {
   ...
   *
   * @generated from protobuf field: repeated TestInfo tests = 3;
   */
  tests: TestInfo[];
  /**
 ...
 *
 * @generated from protobuf message AlertingData
 */
 ...
 *
 * @generated from protobuf message DashboardTabSummary
 */
export interface DashboardTabSummary {
   ...
   *
   * @generated from protobuf field: repeated FailingTestSummary failing_test_summaries = 4;
   */
   ...
   *
   * @generated from protobuf field: DashboardTabSummary.TabStatus overall_status = 7;
   */
   ...
   *
   * @generated from protobuf field: HealthinessInfo healthiness = 12;
   */
   ...
   *
   * @generated from protobuf field: AlertingData alerting_data = 14;
   */
   ...
   *
   * @generated from protobuf field: bool acceptably_flaky = 15;
   */
  acceptablyFlaky: boolean;
  /**
   * Additional metrics provided for the dashboard tab
   *
   * @generated from protobuf field: DashboardTabSummaryMetrics summary_metrics = 16;
   */
  summaryMetrics?: DashboardTabSummaryMetrics;
}
/**
 * @generated from protobuf enum DashboardTabSummary.TabStatus
 */
 ...
 *
 * @generated from protobuf message DashboardTabSummaryMetrics
 */
 ...
 *
 * @generated from protobuf message DashboardSummary
 */
export interface DashboardSummary {
  /**
   * Summary of a dashboard tab; see config.proto.
   *
   * @generated from protobuf field: repeated DashboardTabSummary tab_summaries = 1;
   */
...
class FailingTestSummary$Type extends MessageType<FailingTestSummary> {
  ...
  private binaryReadMap15(
    map: FailingTestSummary['properties'],
    reader: IBinaryReader,
    options: BinaryReadOptions
  ): void {
    let len = reader.uint32(),
      end = reader.pos + len,
      key: keyof FailingTestSummary['properties'] | undefined,
      val: FailingTestSummary['properties'][any] | undefined;
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
      switch (fieldNo) {
        case 1:
        ...
        default:
          throw new globalThis.Error(
            'unknown map entry field for field FailingTestSummary.properties'
          );
      }
    }
    map[key ?? ''] = val ?? '';
  ...
  internalBinaryWrite(
    ...
    if (message.latestFailTestLink !== '')
      writer
        ...
        .string(message.latestFailTestLink);
    ...
    for (let i = 0; i < message.emailAddresses.length; i++)
      writer
        .tag(18, WireType.LengthDelimited)
...
/**
 * @generated MessageType for protobuf message FailingTestSummary
 */
...
class TestInfo$Type extends MessageType<TestInfo> {
  constructor() {
    super('TestInfo', [
      ...
      {
        no: 2,
        name: 'total_non_infra_runs',
        kind: 'scalar',
        T: 5 /*ScalarType.INT32*/,
      },
      {
        no: 3,
        name: 'passed_non_infra_runs',
        kind: 'scalar',
        T: 5 /*ScalarType.INT32*/,
      },
      {
        no: 4,
        name: 'failed_non_infra_runs',
        kind: 'scalar',
        T: 5 /*ScalarType.INT32*/,
      },
      {
        no: 5,
        name: 'failed_infra_runs',
        kind: 'scalar',
        T: 5 /*ScalarType.INT32*/,
      },
      {
        no: 6,
        name: 'total_runs_with_infra',
        kind: 'scalar',
        T: 5 /*ScalarType.INT32*/,
      },
      ...
      {
        no: 9,
        name: 'change_from_last_interval',
        kind: 'enum',
        T: () => ['TestInfo.Trend', TestInfo_Trend],
      },
      {
        no: 11,
        name: 'infra_failures',
  ...
  create(value?: PartialMessage<TestInfo>): TestInfo {
    const message = {
      displayName: '',
      totalNonInfraRuns: 0,
      passedNonInfraRuns: 0,
      failedNonInfraRuns: 0,
      failedInfraRuns: 0,
      totalRunsWithInfra: 0,
      otherRuns: 0,
      flakiness: 0,
      previousFlakiness: [],
      changeFromLastInterval: 0,
      infraFailures: {},
    };
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, {
      enumerable: false,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* repeated float previous_flakiness */ 10:
          ...
          else message.previousFlakiness.push(reader.float());
          break;
        case /* TestInfo.Trend change_from_last_interval */ 9:
  ...
  private binaryReadMap11(
    map: TestInfo['infraFailures'],
    reader: IBinaryReader,
    options: BinaryReadOptions
  ): void {
    let len = reader.uint32(),
      end = reader.pos + len,
      key: keyof TestInfo['infraFailures'] | undefined,
      val: TestInfo['infraFailures'][any] | undefined;
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
      switch (fieldNo) {
        case 1:
        ...
        default:
          throw new globalThis.Error(
            'unknown map entry field for field TestInfo.infra_failures'
          );
      }
    }
    map[key ?? ''] = val ?? 0;
  ...
  internalBinaryWrite(
    ...
    /* TestInfo.Trend change_from_last_interval = 9; */
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* google.protobuf.Timestamp end */ 2:
          ...
          break;
        case /* repeated TestInfo tests */ 3:
          message.tests.push(
            TestInfo.internalBinaryRead(reader, reader.uint32(), options)
          );
          break;
...
/**
 * @generated MessageType for protobuf message HealthinessInfo
 */
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* google.protobuf.Timestamp last_email_time */ 1:
          message.lastEmailTime = Timestamp.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.lastEmailTime
          );
          break;
        default:
          let u = options.readUnknownField;
...
class DashboardTabSummary$Type extends MessageType<DashboardTabSummary> {
  constructor() {
    super('DashboardTabSummary', [
      ...
      {
        no: 4,
        name: 'failing_test_summaries',
        kind: 'message',
        repeat: 1 /*RepeatType.PACKED*/,
        T: () => FailingTestSummary,
      },
      {
        no: 5,
      ...
      { no: 6, name: 'status', kind: 'scalar', T: 9 /*ScalarType.STRING*/ },
      {
        ...
        kind: 'enum',
        T: () => [
          'DashboardTabSummary.TabStatus',
          DashboardTabSummary_TabStatus,
        ],
      },
      {
        no: 8,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* string alert */ 3:
          ...
          break;
        case /* repeated FailingTestSummary failing_test_summaries */ 4:
          message.failingTestSummaries.push(
            FailingTestSummary.internalBinaryRead(
              reader,
              reader.uint32(),
              options
            )
        ...
        case /* string status */ 6:
          ...
          break;
        case /* DashboardTabSummary.TabStatus overall_status */ 7:
        ...
        case /* string bug_url */ 10:
          ...
          break;
        case /* HealthinessInfo healthiness */ 12:
          message.healthiness = HealthinessInfo.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.healthiness
        ...
        case /* repeated string linked_issues */ 13:
          ...
          break;
        case /* AlertingData alerting_data */ 14:
          message.alertingData = AlertingData.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.alertingData
          ...
          break;
        case /* bool acceptably_flaky */ 15:
          message.acceptablyFlaky = reader.bool();
          break;
        case /* DashboardTabSummaryMetrics summary_metrics */ 16:
          message.summaryMetrics =
            DashboardTabSummaryMetrics.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              message.summaryMetrics
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.failingTestSummaries.length; i++)
      FailingTestSummary.internalBinaryWrite(
        message.failingTestSummaries[i],
    ...
    /* DashboardTabSummary.TabStatus overall_status = 7; */
    ...
    if (message.healthiness)
      HealthinessInfo.internalBinaryWrite(
        message.healthiness,
    ...
    if (message.alertingData)
      AlertingData.internalBinaryWrite(
        message.alertingData,
        writer.tag(14, WireType.LengthDelimited).fork(),
        options
      ).join();
    /* bool acceptably_flaky = 15; */
    ...
    if (message.summaryMetrics)
      DashboardTabSummaryMetrics.internalBinaryWrite(
        message.summaryMetrics,
...
/**
 * @generated MessageType for protobuf message DashboardTabSummary
 */
...
class DashboardTabSummaryMetrics$Type extends MessageType<DashboardTabSummaryMetrics> {
  constructor() {
    super('DashboardTabSummaryMetrics', [
      {
        no: 1,
        name: 'completed_columns',
        kind: 'scalar',
        T: 5 /*ScalarType.INT32*/,
      },
      {
        no: 2,
        name: 'passing_columns',
        kind: 'scalar',
        T: 5 /*ScalarType.INT32*/,
      },
      {
  ...
  create(
    value?: PartialMessage<DashboardTabSummaryMetrics>
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: DashboardTabSummaryMetrics
  ): DashboardTabSummaryMetrics {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
...
/**
 * @generated MessageType for protobuf message DashboardTabSummaryMetrics
 */
...
class DashboardSummary$Type extends MessageType<DashboardSummary> {
  ...
  internalBinaryRead(
    ...
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
      switch (fieldNo) {
        case /* repeated DashboardTabSummary tab_summaries */ 1:
...
/**
 * @generated MessageType for protobuf message DashboardSummary
 */
